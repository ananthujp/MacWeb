...
import { selectCAM, selectControlStates } from "../reducer/appSlice";
...
function Notch() {
  ...
  return (
    <div
      className={
        "absolute flex-row justify-around px-14 items-center top-0 bg-black h-6 w-36 rounded-b-lg" +
        (controlState.notch ? " flex" : " hidden")
      }
    >
